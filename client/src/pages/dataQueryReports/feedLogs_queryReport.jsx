...
const FeedLogsQueryReport = () => {
  ...
  const fetchReport = async (applyFilters = true) => {
    try {
        ...
        additional_joins: [
          {
            table: "employees",
            join_condition:
              "feed_schedules.employee_id = employees.Employee_id",
          },
          {
            table: "enclosures",
            join_condition:
              "feed_schedules.enclosure_id = enclosures.enclosure_id",
          },
        ],
        computed_fields: `
                    feed_schedules.*, 
      ...
      const response = await fetch(`${API_BASE_URL}/entryForm/feedLogs`, {
        method: "POST",
    ...
    <div className="feedLogs-query-report">
      ...
      <div className="report-table-container">
        ...
        <div className="edit-feedLogs-button-container">
          <Link to="/feedLog_form" className="edit-feedLogs-button">
            Add Feed Logs
          </Link>
        </div>
      </div>
