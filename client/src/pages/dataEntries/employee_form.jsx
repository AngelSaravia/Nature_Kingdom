  ...
  useEffect(() => {
    ...
    if (employeeData) {
      ...
      const tupleData =
        ...
        JSON.parse(sessionStorage.getItem("employeeEditData") || null);

      if (tupleData) {
        console.log(
          "Using tupleData from location or sessionStorage:",
          tupleData
        ); // Debugging log
        setFormData({
        ...
        <form className={styles.form} onSubmit={(e) => e.preventDefault()}>
          ...
          <div className={styles.formRow}>
            ...
            <InputFields
              ...
              autoComplete="off"
              readOnly={source === "manager_query_report"}
            />
          </div>
...

  {
    /*return (
        <div className={styles.formContainer}>
            <div className={styles.queryReportLink}>
                <Link to="/entryForm/employees" className={styles.queryReportButton}>
                    View Employee Query Report
                </Link>
            </div>
            <h2 className={styles.formTitle}>EMPLOYEE DATA ENTRY FORM</h2>
