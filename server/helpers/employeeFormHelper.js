  ...
  req.on("end", () => {
    try {
      ...
      if (action === "add") {
        ...
        const sql =
          "INSERT INTO employees (first_name, last_name, date_of_birth, salary, user_name, password, department_id, gender, email, phone, Manager_id, Minit_name, street_address, city, state, zip_code, country,role) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)";
        const values = [
          first_name,
          last_name,
          date_of_birth,
        ...
        const sql =
          "UPDATE employees SET first_name = ?, last_name = ?, date_of_birth = ?, salary = ?, user_name = ?, password = ?, department_id = ?, gender = ?, email = ?, phone = ?, Manager_id = ?, Minit_name = ?, street_address = ?, city = ?, state = ?, zip_code = ?, country = ? WHERE Employee_id = ?";
        const values = [
          first_name,
          last_name,
          date_of_birth,
